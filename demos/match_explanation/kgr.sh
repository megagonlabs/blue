...
docker run -d -e NEO4J_USER=$NEO4J_USER -e NEO4J_PWD=$NEO4J_PWD -e profile="1bv5ncadl2srsbmv" -e title="Software Engineer" -e next_title="senior software engineer" --network="host" --name blue_agent_knowledge_grounding blue-agent-knowledge_grounding:latest --session $1 
# Rationalizer Agent
