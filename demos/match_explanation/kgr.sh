...
docker run -e session=$1 -e NEO4J_USER=$NEO4J_USER -e NEO4J_PWD=$NEO4J_PWD --network="host" --name blue_agent_knowledge_grounding -d blue-agent-knowledge_grounding:latest
# Rationalizer Agent
