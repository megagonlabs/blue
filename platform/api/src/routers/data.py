...
service_url = agent_registry.get_agent_property("OPENAI", "service_url")

metadata_properties = {}

if service_url:
    metadata_properties['service_url'] = service_url

metadata = MetaData(properties=metadata_properties)
