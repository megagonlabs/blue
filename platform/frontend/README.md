...
## Getting Started
Create `next-gen/.env.development` and specify correct values (if needed):
```
...
NEXT_PUBLIC_OPERATOR_REGISTRY_NAME=default
NEXT_PUBLIC_MODEL_REGISTRY_NAME=default
NEXT_PUBLIC_TOOL_REGISTRY_NAME=default
