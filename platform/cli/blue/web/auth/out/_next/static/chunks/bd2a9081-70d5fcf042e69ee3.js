"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[939],{5354:function(e,t,i){i.d(t,{X:function(){return eB},c:function(){return tk},o:function(){return ie}});var r,n=i(5816),s=i(4444),a=i(3333),o=i(7582),l=i(8463);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let u=new s.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function d(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${n.Jn}): ${e}`,...t)}/**
 * @license
