...
from tracker import Tracker, Metric, MetricGroup
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", type=str, default="SERVICE")
    ...
    s = Service(name=args.name, prefix=prefix, properties=properties)
