...
class APICallerService(Service):
    def __init__(self, **kwargs):
        if 'name' not in kwargs:
            kwargs['name'] = "APICALLER"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", type=str, default="APICALLER")
    ...
    s = APICallerService(name=args.name, prefix=prefix, properties=properties)
